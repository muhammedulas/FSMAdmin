...
export class NotifierService {
  ...
  warning_top_center(msg: string, timeout: number = 3, title?: string) {
    if (title) {
  ...
  error_top_center(msg: string, timeout: number = 3, title?: string) {
    if (title) {
  ...
  success_top_center(msg: string, timeout: number = 3, title?: string) {
    if (title) {
  ...
  warning_bot_center(msg: string, timeout: number = 3, title?: string) {
    if (title) {
  ...
  error_bot_center(msg: string, timeout: number = 3, title?: string) {
    if (title) {
  ...
  success_bot_center(msg: string, timeout: number = 3, title?: string) {
    if (title) {
  ...
  show_top_center(msg: string, timeout: number = 3, title?: string) {
    if (title) {
